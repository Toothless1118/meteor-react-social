...
const TermsPage = () => (
  <div className="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-12" style={{ marginTop: '30px' }}>
    ...
    <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and any or all Agreements: "Client", “You” and “Your” refers to you, the person accessing this website and accepting the Company’s terms and conditions. “inSlim”,”The Company", “Ourselves”, “We” and "Us", refers to our Company. “Party”, “Parties”, or “Us”, refers to both the Client and ourselves, or either the Client or ourselves. All terms refer to the offer, acceptance and consideration of payment necessary to undertake the process of our assistance to the Client in the most appropriate manner, whether by formal meetings of a fixed duration, or any other means, for the express purpose of meeting the Client’s needs in respect of provision of the Company’s stated services/products, in accordance with and subject to, prevailing English Law. Any use of the above terminology or other words in the singular, plural, capitalisation and/or he/she or they, are taken as interchangeable and therefore as referring to same.</p>
    ...
    <ul>
      <li>
        excludes all representations and warranties relating to this website and its contents or which is or may be provided by any affiliates or any other third party, including in relation to any inaccuracies or omissions in this website and/or the Company’s literature; and </li>
      <li>
    ...
    <h3>Payments</h3>
    <p>Although our website is mostly free, we do sometimes offer paid products. All major Credit/Debit Cards are  acceptable methods of payment. Our Terms are payment in full when your trial period ends (if applicable). All goods remain the property of the Company until paid for in full. </p>

    <h3>Cancellation Policy</h3>
    <p>Although our website is mostly free, we do sometimes offer paid products or services. If you are within your trial period you can cancel anytime by login into your account and clicking on ‘profile’ =&gt; ‘change trial settings’. If your trial period has expired and you have been billed then you can contact us within the next 30 days for a full refund. Minimum 24 hours notice of cancellation required. Notification for instance, in person, via email, mobile phone ‘text message’ and/or fax, or any other means will be accepted subject to confirmation in writing. </p>
    ...
    <p>This Company’s logo is a registered trademark of this Company in the United States and other countries. The brand names and specific services of this Company featured on this web site are trade marked. </p>
    ...
    <p>inslim@inslim.com</p>
    <p>321 430 7546</p>

    <p>This company is registered in 929 Colorado Ave, Santa Monica, CA 90401.  </p>
    ...
    <p className="text-right">© inSlim 2015 All Rights Reserved</p>
  </div>
);
